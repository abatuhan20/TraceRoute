...
, rp2, rp2
        ...
        // int: Time To Live
                 ...
                 rp2, rp2, localIP,    // Source IP address
     ...
     public void run ()
     {
        ...
        long maxDelay = 0;
        int hopCount = 0; // Hesaplanan hop sayısı
 ...
 */
          ...
          deviceCount, // int priority - Priority
                     false,      // boolean: IP flag bit: Delay
                     false,      // boolean: IP flag bit: Through
                     false,      // boolean: IP flag bit: Reliability
          deviceCount, // int: Type of Service (TOS)
                     false,      // boolean: Fragmentation Reservation flag
                     false,      // boolean: Don't fragment flag
                     false,      // boolean: More fragment flag
          // int: Offset
          ...
          // int: Time To Live
                     ...
                     deviceCount, deviceCount, deviceCount, localIP,    // Source IP address
                     remoteIP    // Destination IP address
                     );
          ...
          */
           if (hopCount > 0) {
                    long averageDelay = totalTime / hopCount;
                    println("Minimum Delay: " + minDelay + " ms");
                    println("Maximum Delay: " + maxDelay + " ms");
                    println("Average Delay: " + averageDelay + " ms");
                    println("Total hop count: " + hopCount + " hops");
                    println("Total time: " + totalTime + " ms");
                } else {
                    println("No hops found.");
                }
